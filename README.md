...
## Description
This repository aims to provide all the necessary resources and instructions to reproduce the results presented in https://doi.org/10.1016/j.engappai.2025.112081. It contains the following files and folders:
...
- PMA-QM.py can be executed using `mpirun -n N python ./PMA-QM.py -c CIRCUIT SIZE --pga PGA -s STOP -k CHUNKSIZE;`. The arguments are as follows:
  ...
  - PGA is either 1, 2, or 3 and selects which PGA parameters are wanted (see https://doi.org/10.1007/978-3-031-77941-1_24). To reproduce the results presented in [LINK TO PAPER TO ADD], PGA=1 should be used.
